...
class KerasVisionModel(TFModelV2):
    """Taken from the Generic vision network implemented in ModelV2 API."""

    def __init__(self, obs_space, action_space, num_outputs, model_config,
                 name):
        super(KerasVisionModel, self).__init__(obs_space, action_space,
